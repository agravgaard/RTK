...
::BeforeThreadedGenerateData()
{
  ...
  if (this->GetInputSecondIncidentSpectrum())
    ...
    {
    typedef SpectralForwardModelImageFilter<DecomposedProjectionsType,
    ...
    this->m_DetectorResponse = SpectralForwardType::BinDetectorResponse(this->GetDetectorResponse(),
                                                                        m_Thresholds,
                                                                        m_NumberOfEnergies);
    }
}
